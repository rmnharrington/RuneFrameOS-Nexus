        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 rounded-full flex items-center justify-center">
                <img 
              ...
              <h3 className="text-xl font-fantasy font-bold text-gradient bg-gradient-to-r from-amber-200 to-orange-200 bg-clip-text text-transparent">
                RuneFrameOS™
              </h3>
            </div>
          ...
          {/* Contact Information */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-amber-200">Contact Us</h4>
            ...
            <button className="px-4 py-2 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white rounded-lg transition-all duration-200 hover:scale-105 shadow-md">
              Get in Touch
            </button>
          </div>
        </div>
