...
export default function AppFooter() {
  return (
    <footer className="bg-gradient-to-r from-slate-700 via-slate-800 to-slate-900 text-white border-t-2 border-slate-600/30 shadow-xl">
      <div className="px-4 py-3 lg:px-6 lg:py-4">
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-3 lg:space-y-0">
          ...
          <div className="flex items-center space-x-3">
            <a href="#" className="text-slate-300 hover:text-slate-200 transition-colors p-1">
          ...
          <div className="text-xs text-slate-400 text-center lg:text-right">
            <div>RuneFrameOS Nexus v1.0.0</div>
            <div>© 2024 Bad Guy Gas. All rights reserved.</div>
          </div>
        </div>
      </div>
    </footer>
