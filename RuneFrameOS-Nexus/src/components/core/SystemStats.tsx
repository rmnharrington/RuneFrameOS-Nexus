...
export default function SystemStats({ className = "" }: SystemStatsProps) {
  ...
  return (
    <aside className={`w-80 bg-gradient-to-b from-orange-50 to-red-50 border-l-2 border-orange-300/30 shadow-lg ${className}`}>
      <div className="p-6">
        {/* Header */}
        <div className="mb-6 text-center">
          <div className="w-12 h-12 mx-auto bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center shadow-lg mb-3">
        ...
        <div className="space-y-6">
          {stats.map((section, sectionIndex) => (
            <div key={sectionIndex} className="bg-white/60 rounded-lg border border-orange-200/50 p-4">
              <h4 className="text-sm font-semibold text-orange-800 mb-3 border-b border-orange-200/30 pb-2">
                {section.category}
              </h4>
        ...
        {/* Quick Actions */}
        <div className="mt-6 pt-4 border-t border-orange-300/30">
          <h4 className="text-sm font-medium text-orange-700 mb-3">Quick Actions</h4>
          <div className="space-y-2">
            <button className="w-full p-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg hover:from-orange-600 hover:to-red-600 transition-all duration-200 hover:scale-105 shadow-md text-sm">
              <span className="flex items-center justify-center space-x-2">
                <span>📊</span>
                <span>Detailed Report</span>
              </span>
            </button>
            <button className="w-full p-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg hover:from-blue-600 hover:to-indigo-600 transition-all duration-200 hover:scale-105 shadow-md text-sm">
              <span className="flex items-center justify-center space-x-2">
                <span>⚙️</span>
        ...
        {/* Status Indicator */}
        <div className="mt-6 p-3 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg border border-green-300/50">
