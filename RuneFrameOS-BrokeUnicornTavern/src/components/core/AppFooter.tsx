...
export default function AppFooter() {
  return (
    <footer className="bg-gradient-to-r from-slate-800 via-blue-800 to-indigo-900 border-t-2 border-blue-400/30 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <span className="text-xs text-slate-400">🏰 Established: Year 127</span>
              <span className="text-xs text-slate-400">👥 Capacity: 200+ Travelers</span>
          ...
          {/* Services */}
          <div>
            <h4 className="text-md font-semibold mb-4 text-blue-200">
              Services
            </h4>
