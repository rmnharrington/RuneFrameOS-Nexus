...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: '📋',
    description: 'Download from Mercatrix',
  ...
  },
  {
    ...
    label: 'Durability',
    icon: '⚔️',
    description: 'Track item condition',
    color: 'from-dice-600 to-gold-600'
  },
  {
    id: 'carry-locations',
    label: 'Carry Locations',
    icon: '📍',
    description: 'Manage storage slots',
      ...
      <div className="mt-8 pt-6 border-t border-stone-700/30">
        ...
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gold-300">Shop Open</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            <span className="text-gold-300">15 Items Available</span>
          </div>
        </div>
      </div>
    </div>
