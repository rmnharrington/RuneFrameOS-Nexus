      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-stone-800/50 to-gold-900/50 rounded-lg p-4 border border-stone-700/50">
          <div className="text-center mb-3">
            ...
            <h4 className="font-semibold text-gold-100 text-shadow-stone">Dragon's Fang Sword</h4>
            <p className="text-xs text-gold-300">Legendary Weapon - High Durability</p>
          </div>
          
          {/* Quick Stats */}
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-stone-800/50 rounded p-2 text-center">
              <div className="text-gold-300">Durability</div>
              <div className="text-gold-100 font-bold">95%</div>
            </div>
            <div className="bg-stone-800/50 rounded p-2 text-center">
              <div className="text-gold-300">Location</div>
              <div className="text-gold-100 font-bold">Hand</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              ...
              <span className="text-gold-100 font-bold">Purchased</span>
            </div>
            <div className="text-gold-400">25 gold - Durability: 100%</div>
          </div>
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">Iron Shield</span>
              <span className="text-gold-100 font-bold">Sold</span>
            </div>
            <div className="text-gold-400">15 gold - Durability: 60%</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-character-800/50 to-dice-900/50 rounded-lg p-4 border border-character-700/50">
          <div className="text-center">
            ...
            <div className="text-sm text-character-200 mb-2">Open</div>
            <div className="text-xs text-character-300">15 items available</div>
