...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    label: 'Characters',
    icon: '👤',
    description: 'Player character sheets',
  ...
  },
  {
    ...
    label: 'Settings',
    icon: '⚙️',
    description: 'Game system config',
      ...
      <div className="mt-8 pt-6 border-t border-stone-700/30">
        ...
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gold-300">Session Active</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            <span className="text-gold-300">4 Players Online</span>
          </div>
        </div>
      </div>
    </div>
