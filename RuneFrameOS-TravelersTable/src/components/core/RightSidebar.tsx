      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-stone-800/50 to-gold-900/50 rounded-lg p-4 border border-stone-700/50">
          <div className="text-center mb-3">
            ...
            <h4 className="font-semibold text-gold-100 text-shadow-stone">Shadowfell Expedition</h4>
            <p className="text-xs text-gold-300">D&D 5E - Session 12</p>
          </div>
          
          {/* Quick Stats */}
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-stone-800/50 rounded p-2 text-center">
              <div className="text-gold-300">Players</div>
              <div className="text-gold-100 font-bold">4</div>
            </div>
            <div className="bg-stone-800/50 rounded p-2 text-center">
              <div className="text-gold-300">Level</div>
              <div className="text-gold-100 font-bold">8</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">XP Awarded</span>
              <span className="text-gold-100 font-bold">+300</span>
            </div>
            <div className="text-gold-400">To Rogue player</div>
          </div>
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">Blind Roll</span>
              <span className="text-gold-100 font-bold">d20</span>
            </div>
            <div className="text-gold-400">Stealth check</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-character-800/50 to-dice-900/50 rounded-lg p-4 border border-character-700/50">
          <div className="text-center">
            ...
            <div className="text-xs text-character-300">4 players online</div>
