...
export default function HeroBanner({ 
  ...
  return (
    <div className="relative rounded-lg overflow-hidden border border-stone-700/50">
      {/* Hero Banner Background with aspect ratio */}
      <div 
      ...
      {/* 30% Overlay - lighter for better visibility */}
      <div className="absolute inset-0 bg-black bg-opacity-30" />
      
      {/* Content with proper z-index and fading gradient */}
      <div className="relative z-10 p-6 -mt-20">
        {/* Fading gradient background that blends with the image */}
        <div className="absolute inset-0 bg-gradient-to-t from-stone-900/90 via-stone-800/70 to-transparent rounded-b-lg" />
