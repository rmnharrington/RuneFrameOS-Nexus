...
```
# RuneFrame OS Platform Infrastructure - Primary Control Plane
Host RuneFrame OS Platform-sherlock
...
# RuneFrame OS Platform Infrastructure - GPU Worker Node 1
Host RuneFrame OS Platform-watson
...
# RuneFrame OS Platform Infrastructure - GPU Worker Node 2
Host RuneFrame OS Platform-adler
...
# RuneFrame OS Platform Infrastructure - All nodes (for bulk operations)
Host RuneFrame OS Platform-*
    User RuneFrame OS Platform
    IdentityFile ~/.ssh/PLATFORM_key
    PubkeyAuthentication yes
    PreferredAuthentications publickey
...
4. Select `RuneFrame OS Platform-sherlock`
...
ssh -v RuneFrame OS Platform-sherlock

# Check key permissions
ls -la ~/.ssh/PLATFORM_key*
```
