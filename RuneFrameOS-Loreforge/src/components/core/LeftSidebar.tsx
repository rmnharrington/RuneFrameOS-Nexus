...
const navItems: NavItem[] = [
  {
    ...
    label: 'Worlds',
    icon: '🌍',
    description: 'Create entire worlds',
  ...
  },
  {
    ...
    label: 'Countries',
    icon: '🏰',
    description: 'Manage nations & kingdoms',
  ...
  },
  {
    ...
    label: 'Races',
    icon: '👥',
    description: 'Define species & cultures',
  ...
  },
  {
    ...
    label: 'Galaxies',
    icon: '🌌',
    description: 'Macro-scale management',
  ...
  },
  {
    ...
    label: 'Streets',
    icon: '🏘️',
    description: 'Micro-scale details',
      ...
      <div className="mt-8 pt-6 border-t border-stone-700/30">
        ...
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gold-300">Forge Active</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            <span className="text-gold-300">12 Worlds Created</span>
          </div>
        </div>
      </div>
    </div>
