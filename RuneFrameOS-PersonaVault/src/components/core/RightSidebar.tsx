      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-stone-800/50 to-gold-900/50 rounded-lg p-4 border border-stone-700/50">
          <div className="text-center mb-3">
            ...
            <h4 className="font-semibold text-gold-100 text-shadow-stone">Thorin Stonefist</h4>
            <p className="text-xs text-gold-300">Dwarf Fighter - Level 5</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-stone-800/50 rounded p-2 text-center">
              ...
              <div className="text-gold-100 font-bold">42/42</div>
            </div>
            <div className="bg-stone-800/50 rounded p-2 text-center">
              <div className="text-gold-300">AC</div>
        ...
        <div className="space-y-2">
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">d20 + 5</span>
              <span className="text-gold-100 font-bold">18</span>
            </div>
            <div className="text-gold-400">Attack Roll</div>
          </div>
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">2d6 + 3</span>
              <span className="text-gold-100 font-bold">12</span>
            </div>
            <div className="text-gold-400">Damage</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-character-800/50 to-dice-900/50 rounded-lg p-4 border border-character-700/50">
          <div className="text-center">
            ...
            <div className="text-sm text-character-200 mb-2">Connected</div>
            <div className="text-xs text-character-300">3 templates available</div>
