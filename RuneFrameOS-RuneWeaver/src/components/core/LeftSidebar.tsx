...
const navItems: NavItem[] = [
  {
    ...
    label: 'Workshop',
    icon: '⚡',
    description: 'Main crafting area',
  ...
  },
  {
    ...
    label: 'Enchantments',
    icon: '✨',
    description: 'Active enchantments',
  ...
  },
  {
    ...
    label: 'Recipes',
    icon: '📜',
    description: 'Enchantment formulas',
      ...
      <div className="mt-8 pt-6 border-t border-stone-700/30">
        ...
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gold-300">Workshop Active</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            <span className="text-gold-300">3 Enchantments Active</span>
          </div>
        </div>
      </div>
    </div>
