      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-stone-800/50 to-gold-900/50 rounded-lg p-4 border border-stone-700/50">
          <div className="text-center mb-3">
            ...
            <h4 className="font-semibold text-gold-100 text-shadow-stone">Flame Blade Enchantment</h4>
            <p className="text-xs text-gold-300">Advanced Level - 150 Mana Cost</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div className="bg-stone-800/50 rounded p-2 text-center">
              ...
              <div className="text-gold-100 font-bold">3 Hours</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">Ice Shield Rune</span>
              <span className="text-gold-100 font-bold">2 hours ago</span>
            </div>
            <div className="text-gold-400">Defensive enchantment</div>
          </div>
          <div className="bg-stone-800/50 rounded p-2 text-xs">
            <div className="flex justify-between">
              <span className="text-gold-300">Lightning Strike</span>
              <span className="text-gold-100 font-bold">Yesterday</span>
            </div>
            <div className="text-gold-400">Offensive spell</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-gradient-to-br from-character-800/50 to-dice-900/50 rounded-lg p-4 border border-character-700/50">
          <div className="text-center">
            ...
            <div className="text-xs text-character-300">3 enchantments in progress</div>
